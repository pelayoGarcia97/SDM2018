...
public class DietasViewRecyclerView extends RecyclerView.Adapter<DietasViewRecyclerView.ViewHolder> {

    private final boolean seMuestranReps;
    private List<Dieta> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;
    private Context context;

    // data is passed into the constructor
    public DietasViewRecyclerView(Context context, List<Dieta> data, boolean seMuestranReps) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(nombre.length() > 25)
            ...
            holder.myTextView.setTextSize(22);
